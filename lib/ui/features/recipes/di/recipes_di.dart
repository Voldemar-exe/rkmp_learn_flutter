...
import '../../../../data/datasources/remote/api/recipes_api.dart';
...
void registerRecipesDependencies() {
  ...
  GetIt.I.registerLazySingleton<RecipesApi>(
    () => RecipesApi(GetIt.I<DioClient>().instance),
  );

  GetIt.I.registerLazySingleton<RecipesApiDataSource>(
    () => RecipesApiDataSource(GetIt.I<RecipesApi>()),
  );
